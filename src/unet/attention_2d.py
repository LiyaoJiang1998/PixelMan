...
class Transformer2DModel(ModelMixin, ConfigMixin):
    ...
    def forward(self, hidden_states, encoder_hidden_states=None, timestep=None, return_dict: bool = True, iter_cur=0, save_kv=True, mode='move', mask=None, sa_masking_ipt=False):
        # Input
...
class BasicTransformerBlock(nn.Module):
    ...
    def forward(self, hidden_states, encoder_hidden_states=None, timestep=None, attention_mask=None, video_length=None, iter_cur=0, save_kv=True, mode='move', mask=None, sa_masking_ipt=False):
