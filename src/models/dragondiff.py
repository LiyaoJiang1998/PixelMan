...
from src.unet.attention_processor_dragon import IPAttnProcessor, AttnProcessor, Resampler
from transformers import CLIPVisionModelWithProjection, CLIPImageProcessor
from src.models.Sampler_dragon import Sampler
...
class DragonPipeline:
    ...
    def load_adapter(self, model_path, scale=1.0, 
        ...
        if self.pipe.attention_store:
            self.pipe.attention_store.num_att_layers = att_count # Count attn layers
